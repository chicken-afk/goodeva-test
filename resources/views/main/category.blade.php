                                                ...
                                                @foreach ($row['datas'] as $key => $value )                                                    
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            ...
                                                            <a href="{{ route('deleteCategory', $value->id) }}" class="btn btn-icon btn-light btn-hover-primary btn-sm">
                                                                <span class="svg-icon svg-icon-md svg-icon-primary">
                                                                            ...
                                                                            <form action="{{ route('updateCategory') }}" method="POST">
                                                                             ...
                                                                             <div class="card-body">
                                                                              ...
                                                                              <div class="form-group">
                                                                               ...
                                                                               <input type="text" class="form-control" name="category_name" value="{{ $value->category_name }}"  placeholder="Enter Kategori Name" required />
                ...
                <div class="card card-custom">
                    ...
                    <form action="{{ route('postCategory') }}" method="POST">
                     ...
                     <div class="card-body">
                      ...
                      <div class="form-group">
                       <label>Nama Kategori<span class="text-danger">*</span></label>
                       <input type="text" class="form-control" name="category_name"  placeholder="Enter Kategori Name" required />
                       <span class="form-text text-muted">Kategori produk, contoh : "Makanan", "Minuman", "Desert</span>
                      </div>
                     </div>
                    <!--end::Form-->
