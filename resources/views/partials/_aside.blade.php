	...
	<div class="aside-nav d-flex flex-column align-items-center flex-column-fluid pt-7">
		...
		<ul class="nav flex-column">
			...
			<li class="nav-item mb-5" data-toggle="tooltip" data-placement="right" data-container="body" data-boundary="window" title="Dashboard">
				<a href="{{ route('dashboard') }}" class="nav-link btn btn-icon btn-clean btn-icon-white btn-lg {{ set_active('dashboard') }}">
			...
			<!--begin::Item-->
			<li class="nav-item mb-5" data-toggle="tooltip" data-placement="right" data-container="body" data-boundary="window" title="Pesanan">
				<a href="#" class="nav-link btn btn-icon btn-clean btn-icon-white btn-lg" data-toggle="tab" data-target="#kt_aside_tab_3" role="tab">
			...
			<li class="nav-item mb-5" data-toggle="tooltip" data-placement="right" data-container="body" data-boundary="window" title="Laporan">
				<a href="#" class="nav-link btn btn-icon btn-clean btn-icon-white btn-lg" data-toggle="tab" data-target="#kt_aside_tab_2" role="tab">
			...
			<!--begin::Item-->
			<li class="nav-item mb-5" data-toggle="tooltip" data-placement="right" data-container="body" data-boundary="window" title="Master Data">
				<a href="{{ route('getProduct') }}" class="nav-link btn btn-icon btn-clean btn-icon-white btn-lg {{ set_active(['getProduct', 'getCategory','getOutlets', 'addProductPage']) }}" role="tab">
			...
			<!--begin::Item-->
			<li class="nav-item mb-5" data-toggle="tooltip" data-placement="right" data-container="body" data-boundary="window" title="Setting">
